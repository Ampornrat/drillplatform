...
export default async function DrillDetailPage({
  ...
  const drillResult = await getDrillDetail(id, ctx.userId, ctx.role)
  if (!drillResult.ok) notFound()
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-4 mt-2 text-xs text-gray-400 flex-wrap">
            ...
            {drill.organizationName && <span>{drill.organizationName}</span>}
          </div>
        </div>
        <DrillStatusActions
          drillId={drill.id}
        ...
        <Card>
          <CardContent className="py-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold">{drill.participantCount}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="py-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold">{drill.recentEvents.length}</p>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            <CardContent className="py-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{drill.maxParticipants} คน</p>
              </div>
            </CardContent>
          </Card>
        )}
